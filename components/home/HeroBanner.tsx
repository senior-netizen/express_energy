    ...
    <section className='relative isolate overflow-hidden bg-brand-dark py-24 text-white md:py-28'>
      ...
      <div className='container-page'>
        ...
        <div className='mt-8 flex flex-col gap-3 md:flex-row'>
          <Link
            href='/fuel-prices'
            className='ui-focus-ring ui-press ui-hover-lift inline-flex items-center justify-center rounded-full bg-brand-primary px-7 py-3 text-center font-medium motion-safe:transition hover:brightness-95'
          >
            View Fuel Prices
          </Link>
          <Link
            href='/find-a-station'
            className='ui-focus-ring ui-press ui-hover-lift inline-flex items-center justify-center rounded-full border border-white/60 px-7 py-3 text-center font-medium motion-safe:transition hover:bg-white/10'
          >
            Find a Station
          </Link>
        </div>
